...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get howMuchWeHaveDoneTogether => 'Cuánto hemos hecho juntos';
  ...
  String storiesThisWeek(int count) {
    return 'Historias contadas esta semana: $count';
  }

  @override
  String get tapChartToSeeWeekly => 'Toca el gráfico para ver la semana';
  ...
  @override
  String get continuityHookBadge => '📖 Historia abierta';

  @override
  String get continuityHookG01 =>
      'Mirando lo que escribiste hace unos días, ¿cómo ves esa situación hoy?';

  @override
  String get continuityHookG02 =>
      '¿Recuerdas el episodio que relataste recientemente? ¿Cómo se desarrollaron las cosas desde entonces?';

  @override
  String get continuityHookG03 =>
      'Escribiste un relato muy breve. ¿Quieres intentar hablar más del asunto?';

  @override
  String get continuityHookTalvez =>
      '¿Crees que aquella situación de hace unos días todavía está ocurriendo?';

  @override
  String get continuityHookNaoSei =>
      '¿Cómo ves hoy lo que escribiste aquel día?';

  @override
  String get continuityHookBtnContinue => 'Continuar';

  @override
  String get continuityHookBtnOptions => 'Opciones';

  @override
  String get continuityHookFreeLimitTitle => 'Función exclusiva';

  @override
  String get continuityHookFreeLimitBody =>
      'Ya has utilizado tus 3 historias gratuitas con seguimiento de continuidad. Actualiza a Premium y escribe narrativas sin límite.';

  @override
  String get continuityHookDebugSectionTitle => 'Motor de Ganchos (Debug)';

  @override
  String get continuityHookDebugAcceleratorLabel => 'Acelerador de Reloj';

  @override
  String get continuityHookDebugAcceleratorSubtitle =>
      'Ignora las ventanas de tiempo de 2/3/4 días';

  @override
  String get continuityHookDebugResetCounters => 'Reiniciar Contador Free';

  @override
  String get continuityHookDebugForceReload => 'Forzar Recarga de Tarjeta';

  @override
  String get continuityHookFeatureLabel =>
      'Continuidad de Historias (≤3 Free · Ilimitado Premium)';

  @override
  String get continuityHookGenericSim => 'Es hora de continuar esta historia';

  @override
  String get continuityHookGenericTalvez =>
      'Quizás quieras continuar esta historia';

  @override
  String get continuityHookGenericNaoSei =>
      '¿Has decidido si quieres continuar esta historia?';

  @override
  String get continuityStatusClose => 'Cerrar';

  @override
  String get continuityInfoTitle => 'Historias Vivas';

  @override
  String get continuityInfoDesc =>
      '### Historias Vivas: Conecta tus memorias\nEn DayApp, puedes conectar tus registros para seguir el desarrollo de un evento a lo largo de los días. Al finalizar una nota, puedes indicar si esa situación tendrá más desarrollos, quizás generando un nuevo Capítulo.\n### ¿Cómo funciona?\nAl guardar una nueva historia, te preguntaremos si deseas continuar esa historia más tarde. Si seleccionas Sí, Quizás o No sé, la aplicación mostrará recordatorios automáticos en la pantalla de inicio después de algunos días. Esto sirve como un recordatorio práctico para que actualices lo sucedido en una nueva nota, que dará continuidad al asunto, o en la historia original.\n### Tu momento de reflexión:\nEn la pantalla de inicio, tendrás la oportunidad de evaluar el estado del registro:\n- Continuar la historia: Elige entre crear una nueva o editar la historia original.\n- Cerrar el ciclo: Si la situación ya se resolvió o ya no deseas seguirla, simplemente cambia el estado a No para retirarla de la cola de recordatorios.';

  @override
  String get continuityHookOptionNewStory => 'Nueva historia';

  @override
  String get continuityHookOptionSameStory => 'Misma historia';

  @override
  String birthdayMessageToday(String name) {
    return '¡Felicidades $name! Nos alegra estar aquí contigo en este día.';
  }

  @override
  String birthdayMessagePassed(String date) {
    return '¡Felicidades! Vimos que tu cumpleaños fue el $date. Nos alegra acompañar tu camino.';
  }
}
